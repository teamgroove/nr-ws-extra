...
module.exports = function (RED) {
    ...
    RED.nodes.registerType("websocket-listener-extra", WebSocketListenerNode);
    RED.nodes.registerType("websocket-client-extra", WebSocketListenerNode);
    ...
    RED.nodes.registerType("websocket in extra", WebSocketInNode);
    ...
    RED.nodes.registerType("websocket out extra", WebSocketOutNode);
}
